...
const Bar = props => {
  ...
  function calcClickedTime(e) {
    ...
    const bar = document.querySelector("#track1bar");
...
function UntitledNoSolo() {
  const { curTime, duration, playing, setPlaying, setClickedTime } = useAudioPlayer();

  return (
    <div className={AudioStyles.wrapper}>
      <audio id='track1'>
        <source src="https://res.cloudinary.com/mimas-music/video/upload/v1583444010/johndavidpena/music%20blog%20assets/untitled_FINAL_noSolo.mp3" />
        Your browser does not support the <code>audio</code> element.
      </audio>
      <Song songName="Untitled - No Solo" songArtist="John Pena" />
