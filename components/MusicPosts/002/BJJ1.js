...
function useAudioPlayer() {
  ...
  useEffect(() => {
    const audio = document.getElementById('track3');
...
const Bar = props => {
  ...
  function calcClickedTime(e) {
    ...
    const bar = document.querySelector("#track3bar");
...
function BJJ1() {
  ...
  return (
    <div className={AudioStyles.wrapper}>
      <audio id='track3'>
        <source src="https://res.cloudinary.com/mimas-music/video/upload/v1586902255/johndavidpena/music%20blog%20assets/jiuJitsuSketch.mp3" />
        Your browser does not support the <code>audio</code> element.
      </audio>
      <Song songName="Crush Ur Soul" songArtist="John Pena" />
